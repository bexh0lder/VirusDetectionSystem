...
namespace VirusDetectionSystem.Utilities
{
    ...
    public class PEHelper
    {
        ...
        private void LoadImportDirectory()
        {
            ...
            while (true)
            {
                ImportDirectory.ImportDate Import = new PEHelper.ImportDirectory.ImportDate();
            ...
            for (int z = 0; z != _ImportDirectory.ImportList.Count; z++)     //获取引入方法
            {
                ...
                while (true)
                {
                    ImportDirectory.ImportDate.FunctionList Function =
                        new PEHelper.ImportDirectory.ImportDate.FunctionList();
                    ...
                    //发现有些数字超级大
                    if (LoadIndex >= StarRva && LoadIndex < StarRva + EndRva)
                    {
                        int ReadCount = 0;
